                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      >
                        <CardContent className="p-4 flex flex-col items-center justify-center text-center">
                          <Sun className="h-8 w-8 mb-2 text-orange-400 animate-pulse" />
                      ...
                      >
                        <CardContent className="p-4 flex flex-col items-center justify-center text-center">
                          <Moon className="h-8 w-8 mb-2 text-blue-400 animate-pulse" />
                      ...
                      >
                        <CardContent className="p-4 flex flex-col items-center justify-center text-center">
                          <Monitor className="h-8 w-8 mb-2 text-purple-400 animate-pulse" />
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <Card className="p-4 cursor-pointer hover:shadow-md border-primary/50 hover:scale-105 transition-transform">
                        ...
                        <Card className="p-4 cursor-pointer hover:shadow-md hover:scale-105 transition-transform">
