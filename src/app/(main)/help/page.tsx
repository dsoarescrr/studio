...
import { 
  ...
  Share2, Copy, Send, Play, Pause, Sparkles, Bookmark
} from "lucide-react";
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 bg-card/50 rounded-lg shadow-inner">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Se não conseguir iniciar sessão, tente limpar os cookies do navegador ou utilizar o modo de navegação privada.
                    </p>
                  </div>
                  <div className="p-4 bg-card/50 rounded-lg shadow-inner">
                    <h3 className="font-semibold flex items-center mb-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Se os seus créditos não foram adicionados após uma compra, aguarde 15 minutos e verifique novamente.
                    </p>
                  </div>
                  <div className="p-4 bg-card/50 rounded-lg shadow-inner">
                    <h3 className="font-semibold flex items-center mb-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Ative o "Modo de Desempenho" nas definições para melhorar a velocidade em dispositivos menos potentes.
                    </p>
                  </div>
                </div>
              </CardContent>
              <CardFooter className="flex justify-center border-t border-primary/10 pt-4">
                <Button variant="outline" className="w-full sm:w-auto" onClick={() => setActiveTab('faq')}>
                  <Book className="h-4 w-4 mr-2" />
                  Ver Todas as FAQs
                </Button>
              </CardFooter>
          ...
          <TabsContent value="resources" className="space-y-6">
                ...
                <CardContent>
                  <ScrollArea className="h-[40vh]">
                    <div className="space-y-3">
                      ...
                      <div className="p-3 border-b border-border/50">
                        <h4 className="font-medium">XP (Pontos de Experiência)</h4>
                        <p className="text-sm text-muted-foreground mt-1">Pontos ganhos através de atividades na plataforma que determinam o nível do utilizador.</p>
                      </div>
                      <div className="p-3 border-b border-border/50">
                        <h4 className="font-medium">Álbum</h4>
                        <p className="text-sm text-muted-foreground mt-1">Coleção temática de pixels criada por um utilizador.</p>
                      </div>
                      <div className="p-3">
                        <h4 className="font-medium">Pixel Art</h4>
                        <p className="text-sm text-muted-foreground mt-1">Forma de arte digital criada através da edição de pixels individuais para formar uma imagem.</p>
                      </div>
                    </div>
                  </ScrollArea>
                </CardContent>
            ...
            <Card className="bg-gradient-to-br from-primary/10 to-accent/5 border-primary/20 shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Conteúdo criado e partilhado pela comunidade do Pixel Universe
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 bg-card/50 rounded-lg shadow-inner">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Guias detalhados criados por utilizadores experientes sobre estratégias avançadas e técnicas de pixel art.
                    </p>
                  ...
                  <div className="p-4 bg-card/50 rounded-lg shadow-inner">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Participe em discussões sobre todos os aspetos do Pixel Universe, desde técnicas até estratégias de mercado.
                    </p>
                    <Button variant="outline" size="sm" className="mt-3 w-full">
                      <ExternalLink className="h-3 w-3 mr-1" />
                      Visitar Fórum
                  ...
                  <div className="p-4 bg-card/50 rounded-lg shadow-inner">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Calendário de eventos, concursos e workshops organizados pela comunidade e pela equipa do Pixel Universe.
                    </p>
                    <Button variant="outline" size="sm" className="mt-3 w-full">
                      <ExternalLink className="h-3 w-3 mr-1" />
                      Ver Calendário
        ...
        <Card className="bg-card/80 backdrop-blur-sm">
          <CardContent className="p-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Button variant="outline" className="flex flex-col h-auto py-4 gap-2 hover:bg-primary/10 transition-colors">
                <Video className="h-5 w-5 text-primary" />
                <span className="text-sm">Vídeos Tutoriais</span>
              </Button>
              <Button variant="outline" className="flex flex-col h-auto py-4 gap-2 hover:bg-primary/10 transition-colors">
                <Book className="h-5 w-5 text-green-500" />
                <span className="text-sm">Guia do Utilizador</span>
              </Button>
              <Button variant="outline" className="flex flex-col h-auto py-4 gap-2 hover:bg-primary/10 transition-colors">
              ...
              <Button variant="outline" className="flex flex-col h-auto py-4 gap-2 hover:bg-primary/10 transition-colors">
                ...
                <span className="text-sm">Dicas & Truques</span>
              </Button>
            </div>
          </CardContent>
        </Card>
